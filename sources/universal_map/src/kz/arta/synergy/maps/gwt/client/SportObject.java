...
//    }
    ...
    private HashMap<String,String> mapField = new HashMap();
...
//        }
    ...
    public String getRedirectedUrl(){
        if(documentId!=null)
        return "../../Synergy/Synergy.html?#submodule=common&action=open_document&document_identifier="+this.getDocumentId();
        else return null;
    }
    ...
    public void setMapField(HashMap mapField) {
